...
const carData: { [key: number]: CarProps & { description: string, features: string[], gallery: string[] } } = {
  ...
  5: {
    ...
    description: "Brand new 2024 Mercedes-AMG GLE 53 with cutting-edge luxury and performance. This premium SUV combines AMG performance with Mercedes luxury, featuring a powerful 3.0L V6 Turbo engine and sophisticated 4MATIC all-wheel drive system.",
    features: [
      "AMG 3.0L V6 Biturbo Engine",
  ...
  6: {
    ...
    transmission: "Automatic",
    engine: "3.0L V6",
    description: "The epitome of luxury SUVs, this brand new 2024 Range Rover Sport combines exceptional off-road capability with refined on-road performance. Features the latest Pivi Pro infotainment system and Terrain Response technology.",
    features: [
      "3.0L V6 Supercharged Engine",
      "Terrain Response 2",
